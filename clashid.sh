...
echo -e "  Author : ${green} » ${NC}${YELLOW}(${NC} ${green} CLASHERS TEAM ${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/"
...
TIMES="10"
CHATID="-1002144371411"
KEY="6926798926:AAHwjBFCH4eM0BSj-rI7TvvdR6_uWxSrbZA"
URL="https://api.telegram.org/bot$KEY/sendMessage"
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/izin | grep $ipsaya | awk '{print $3}')
...
<code>──────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/bittercheeze"},{"text":"INSTALL","url":"https://t.me/bittercheeze"}]]}'
...
wget raw.githubusercontent.com/clash-id-repo/CLASH-VIP-VPN/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
